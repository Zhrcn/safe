...
import {
    FileText, HeartPulse, DropletIcon, Stethoscope, BarChart3, FileImage, Pill, Shield, History, User, Home, CalendarDays, Info, Eye, FilePlus2
} from 'lucide-react';
            ...
            <CardContent className="p-0">
                <Tabs value={medicalTabValue} onValueChange={setMedicalTabValue} className="w-full">
                    <TabsList className="flex flex-wrap gap-2 p-4">
                        {medicalRecordCategories.map(cat => (
