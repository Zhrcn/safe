...
const Toast = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "pointer-events-auto flex w-full max-w-md rounded-lg border border-border bg-background text-foreground shadow-lg ring-1 ring-black ring-opacity-5",
      className
    )}
    {...props}
  />
...
const ToastDestructive = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "pointer-events-auto flex w-full max-w-md rounded-lg border border-destructive bg-destructive text-destructive-foreground shadow-lg ring-1 ring-black ring-opacity-5",
      className
    )}
    {...props}
  />
